    ...
    <div className="min-h-screen bg-scada-bg flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl border border-scada-accent/30 bg-scada-panel mb-6"
            style={{ boxShadow: '0 0 30px rgba(0,212,255,0.2)' }}>
            <Droplets className="w-10 h-10 text-scada-accent" />
          </div>
